...
- Tune holdout: `54.17%` exact beat, `54.90%` root-only, `78.92%` change placement
- On chord onsets only: `49.90%` exact, `50.55%` root-only
- Type highlights: `55.15%` for jigs, `55.46%` for reels, `56.39%` for polkas, `53.68%` for waltzes
