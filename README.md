...
- Tune holdout: `53.96%` exact beat, `54.71%` root-only, `78.53%` change placement
- On chord onsets only: `49.56%` exact, `50.24%` root-only
- Type highlights: `54.85%` for jigs, `55.08%` for reels, `56.12%` for polkas, `53.88%` for waltzes
